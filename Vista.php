<?php
	...
	class Vista {
		...
		public function dibujarReloj($modelo){
			...
			imagestring($this->img, 15, 270, 60, 1, $this->negro);	
			imagestring($this->img, 15, 320, 120, 2, $this->negro);
			imagestring($this->img, 15, 340, 195, 3, $this->negro);
			imagestring($this->img, 15, 330, 265, 4, $this->negro);
			...
			imagestring($this->img, 3, 75, 270, 8, $this->negro);
			imagestring($this->img, 3, 55, 193, 9, $this->negro);
			imagestring($this->img, 3, 75, 120, 10, $this->negro);
			...
			if($modelo->min > 14 && $modelo->min<61){
				imageline($this -> img,$modelo->centrox,$modelo->centroy, $modelo->arrptosint[$modelo->min-16]->x,$modelo->arrptosint[$modelo->min-16]->y,$this->negro);
			}
